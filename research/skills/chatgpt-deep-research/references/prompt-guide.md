# ChatGPT Deep Research — Prompt Improvement Guide
...
- Should specific sources be prioritized or excluded?
- ChatGPT's "Sites" filter can restrict web search to specific domains
- If the caller mentions specific sources, note that Sites filter can be used
